...
import org.steamflake.templates.domain.transform.impl.services.output.SteamflakeTmToJavaOutputModelTransformer;
...
public class SteamflakeTmToJavaModelTransformer {
    ...
    void generateJavaOutputModel( ISteamflakeTmRootPackage rootPackage, IJavaRootPackage javaRootPackage ) {
        new SteamflakeTmToJavaOutputModelTransformer().transformRootPackage( rootPackage, javaRootPackage );
    }
